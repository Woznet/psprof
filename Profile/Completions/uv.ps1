...
<#
    .SYNOPSIS
        `uv` CLI PowerShell Tab Completion.
    .DESCRIPTION
        This script registers `uv` CLI shell completions for PowerShell.
    .LINK
        https://
#>
...
Begin {
    ...
    Write-Verbose '[BEGIN]: uv Completion'

    if (!(Get-Command uv -ErrorAction SilentlyContinue)) {
        Write-Error "Chocolatey command 'uv' not found or is not installed. Please install and try again."
    }
}

Process {

    Write-Verbose '[PROCESS]: uv Completion'
    ...
    try {
        ...
        Register-ArgumentCompleter -Native -CommandName 'uv' -ScriptBlock {
            ...
            $completions = @(switch ($command) {
                    ...
                    'uv;run' {
                        ...
                        [CompletionResult]::new('--no-default-groups', '--no-default-groups', [CompletionResultType]::ParameterName, 'Ignore the the default dependency groups')
                    ...
                    'uv;python;list' {
                        ...
                        [CompletionResult]::new('--only-downloads', '--only-downloads', [CompletionResultType]::ParameterName, 'Only show Python downloads, exclude installed distributions')
        ...
        Write-Error 'Failed to register uv shell completion for powershell.'
    }

}

End {
    Write-Verbose '[END]: uv Completion'
}
